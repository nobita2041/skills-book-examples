"""E2E tests for Task Manager app (bundle.html): add, complete, and delete tasks."""

import re
from pathlib import Path
from playwright.sync_api import sync_playwright, expect

BUNDLE_PATH = Path(__file__).parent / "bundle.html"
APP_URL = f"file://{BUNDLE_PATH.resolve()}"
...
def test_task_operations():
    with sync_playwright() as p:
        ...
        # Take initial screenshot for reconnaissance
        page.screenshot(path="/tmp/e2e_bundle_init.png", full_page=True)
        ...
        page.screenshot(path="/tmp/e2e_bundle_after_add.png", full_page=True)
        ...
        page.screenshot(path="/tmp/e2e_bundle_after_complete.png", full_page=True)
        ...
        page.screenshot(path="/tmp/e2e_bundle_after_delete.png", full_page=True)
        ...
        # Final screenshot
        page.screenshot(path="/tmp/e2e_bundle_final.png", full_page=True)

        print("\n=== All E2E tests passed! (bundle.html) ===")
        browser.close()
